import { c as Bu } from "./_commonjsHelpers-725317a4.js";
function nr(u, e) {
...
var Se = Ar,
  or = Se;
function Fr(u, e) {
  for (var r = u.length; r--; ) if (or(u[r][0], e)) return r;
  return -1;
}
var mu = Fr,
  Cr = mu,
...
function Er(u) {
  ...
  if (r < 0) return !1;
  var t = e.length - 1;
  return r == t ? e.pop() : cr.call(e, r, 1), --this.size, !0;
}
var pr = Er,
  fr = mu;
function Br(u) {
...
uu.prototype.clear = xr;
uu.prototype.delete = Tr;
uu.prototype.get = br;
uu.prototype.has = Sr;
uu.prototype.set = $r;
var _u = uu,
...
var kr = Mr,
  Ur = typeof Bu == "object" && Bu && Bu.Object === Object && Bu,
  $e = Ur,
  jr = $e,
  Gr = typeof self == "object" && self && self.Object === Object && self,
  Kr = jr || Gr || Function("return this")(),
  H = Kr,
  Hr = H,
  qr = Hr.Symbol,
  xu = qr,
...
function Ct(u) {
  if (!st(u)) return !1;
  var e = it(u);
  return e == At || e == ot || e == Dt || e == Ft;
}
var Oe = Ct,
  lt = H,
  ct = lt["__core-js_shared__"],
  Et = ct,
  Nu = Et,
  re = (function () {
...
function t0(u) {
  var e = this.__data__;
  return u0 ? e[u] !== void 0 : r0.call(e, u);
}
var a0 = t0,
  n0 = Tu,
...
eu.prototype.clear = A0;
eu.prototype.delete = o0;
eu.prototype.get = F0;
eu.prototype.has = C0;
eu.prototype.set = l0;
var c0 = eu,
...
function v0(u, e) {
  var r = u.__data__;
  return d0(e) ? r[typeof e == "string" ? "string" : "hash"] : r.map;
}
var bu = v0,
  g0 = bu;
function m0(u) {
  var e = g0(this, u).delete(u);
  return (this.size -= e ? 1 : 0), e;
}
var _0 = m0,
  x0 = bu;
function T0(u) {
  return x0(this, u).get(u);
}
var b0 = T0,
  S0 = bu;
function $0(u) {
  return S0(this, u).has(u);
}
var w0 = $0,
  O0 = bu;
function N0(u, e) {
...
ru.prototype.clear = I0;
ru.prototype.delete = R0;
ru.prototype.get = L0;
ru.prototype.has = M0;
ru.prototype.set = k0;
var qu = ru,
...
var q0 = H0,
  ...
  Y0 = q0;
function tu(u) {
  var e = (this.__data__ = new W0(u));
  this.size = e.size;
}
tu.prototype.clear = z0;
tu.prototype.delete = V0;
tu.prototype.get = J0;
tu.prototype.has = Q0;
tu.prototype.set = Y0;
var Pe = tu,
...
function Z0(u) {
  return this.__data__.set(u, X0), this;
}
var ua = Z0;
function ea(u) {
  return this.__data__.has(u);
...
function yu(u) {
  var e = -1,
    r = u == null ? 0 : u.length;
  for (this.__data__ = new ta(); ++e < r; ) this.add(u[e]);
}
yu.prototype.add = yu.prototype.push = aa;
yu.prototype.has = na;
var ia = yu;
function sa(u, e) {
...
function pa(u, e, r, t, a, s) {
  ...
  for (s.set(u, e), s.set(e, u); ++x < l; ) {
    ...
    if (m) {
      if (
        !Ca(e, function (I, L) {
          if (!la(m, L) && (d === I || a(d, I, r, t, s))) return m.push(L);
        })
      ) {
        F = !1;
        break;
...
function ja(u, e, r, t, a, s, n) {
  switch (r) {
    ...
    case ka:
      return !(u.byteLength != e.byteLength || !s(new ie(u), new ie(e)));
    case $a:
    case wa:
    case Pa:
      return ma(+u, +e);
    ...
    case Ra:
      var p = t & ba;
      if ((l || (l = Ta), u.size != e.size && !p)) return !1;
      var E = n.get(u);
      if (E) return E == e;
      (t |= Sa), n.set(u, e);
      var T = _a(l(u), l(e), t, a, s, n);
      return n.delete(u), T;
    case Ma:
...
var cn = ln,
  ...
  En = cu,
  Re = Object.prototype,
  pn = Re.hasOwnProperty,
  fn = Re.propertyIsEnumerable,
  Bn = Ae(
    (function () {
      return arguments;
    })()
    ...
    ? Ae
    : function (u) {
        return En(u) && pn.call(u, "callee") && !fn.call(u, "callee");
      },
  Le = Bn,
  Cu = {},
  hn = {
...
var Me = mn,
  _n = 9007199254740991;
function xn(u) {
  return typeof u == "number" && u > -1 && u % 1 == 0 && u <= _n;
}
var Wu = xn,
  Tn = lu,
  bn = Wu,
  ...
  S = {};
S[qn] = S[Wn] = S[zn] = S[Vn] = S[Jn] = S[Qn] = S[Yn] = S[Xn] = S[Zn] = !0;
S[$n] =
  S[wn] =
  S[Kn] =
  S[On] =
  ...
  S[Gn] =
    !1;
function ui(u) {
  return Sn(u) && bn(u.length) && !!S[Tn(u)];
}
var ei = ui;
function ri(u) {
  return function (e) {
...
function hi(u) {
  var e = u && u.constructor,
    r = (typeof e == "function" && e.prototype) || Bi;
  return u === r;
}
var yi = hi;
function di(u, e) {
...
function Si(u) {
  if (!_i(u)) return xi(u);
  var e = [];
  for (var r in Object(u)) bi.call(u, r) && r != "constructor" && e.push(r);
  return e;
}
var $i = Si,
  wi = Oe,
  Oi = Wu;
function Ni(u) {
  return u != null && Oi(u.length) && !wi(u);
}
var Pi = Ni,
  Ii = fi,
  Ri = $i,
...
var Ki = Gi,
  ...
  Hi = 1,
  qi = Object.prototype,
  Wi = qi.hasOwnProperty;
function zi(u, e, r, t, a, s) {
  var n = r & Hi,
    l = Ce(u),
    p = l.length,
    E = Ce(e),
  ...
  for (var x = p; x--; ) {
    var F = l[x];
    if (!(n ? F in e : Wi.call(e, F))) return !1;
  }
  var m = s.get(u),
    d = s.get(e);
...
var fs = Q,
  ...
  hu = "[object Object]",
  gs = Object.prototype,
  ge = gs.hasOwnProperty;
function ms(u, e, r, t, a, s) {
  var n = he(u),
    l = he(e),
    p = n ? ve : Be(u),
    E = l ? ve : Be(e);
  (p = p == de ? hu : p), (E = E == de ? hu : E);
  var T = p == hu,
    x = E == hu,
    F = p == E;
  if (F && ye(u)) {
  ...
  if (F && !T)
    return (
      s || (s = new Iu()),
      n || ds(u) ? Bs(u, e, r, t, a, s) : hs(u, e, p, r, t, a, s)
    );
  if (!(r & vs)) {
    ...
    if (m || d) {
      var c = m ? u.value() : u,
        f = d ? e.value() : e;
      return s || (s = new Iu()), a(c, f, r, t, s);
    }
  }
  return F ? (s || (s = new Iu()), ys(u, e, r, t, a, s)) : !1;
}
var _s = ms,
  xs = _s,
  me = cu;
...
function ws(u, e, r, t) {
  ...
  for (; ++a < s; ) {
    ...
    if (n && l[2]) {
      ...
      if (!(F === void 0 ? bs(T, E, Ss | $s, t, x) : F)) return !1;
    }
  }
  return !0;
}
...
var Hs = Ks,
  ...
  zs = "[object Symbol]";
function Vs(u) {
  return typeof u == "symbol" || (Ws(u) && qs(u) == zs);
}
var Vu = Vs,
  Js = W,
  Qs = Vu,
...
function Zs(u, e) {
  if (Js(u)) return !1;
  var r = typeof u;
  return r == "number" || r == "symbol" || r == "boolean" || u == null || Qs(u)
    ? !0
    : Xs.test(u) || !Ys.test(u) || (e != null && u in Object(e));
}
var Ju = Zs,
  We = qu,
...
function ze(u) {
  ...
  if (CD(u)) return FD(u, ze) + "";
  if (lD(u)) return Te ? Te.call(u) : "";
  var e = u + "";
  return e == "0" && 1 / u == -cD ? "-0" : e;
}
var ED = ze,
  pD = ED;
function fD(u) {
...
var BD = fD,
  ...
  vD = BD;
function gD(u, e) {
  return hD(u) ? u : yD(u, e) ? [u] : dD(vD(u));
}
var Ve = gD,
  mD = Vu,
  _D = 1 / 0;
function xD(u) {
  if (typeof u == "string" || mD(u)) return u;
  var e = u + "";
  return e == "0" && 1 / u == -_D ? "-0" : e;
}
var Su = xD,
  TD = Ve,
  bD = Su;
function SD(u, e) {
  e = TD(e, u);
  for (var r = 0, t = e.length; u != null && r < t; ) u = u[bD(e[r++])];
  return r && r == t ? u : void 0;
}
var Je = SD,
  $D = Je;
function wD(u, e, r) {
  var t = u == null ? void 0 : $D(u, e);
  return t === void 0 ? r : t;
}
var OD = wD;
function ND(u, e) {
...
function jD(u, e, r) {
  ...
  return s || ++t != a
    ? s
    : ((a = u == null ? 0 : u.length),
      !!a && kD(a) && MD(n, a) && (LD(u) || RD(u)));
}
var GD = jD,
  KD = PD,
  HD = GD;
function qD(u, e) {
  return u != null && HD(u, e, KD);
}
var WD = qD,
  zD = Ke,
  VD = OD,
...
function r1(u, e) {
  return QD(u) && YD(e)
    ...
    : function (r) {
        var t = VD(r, u);
        return t === void 0 && t === e ? JD(r, u) : zD(e, t, u1 | e1);
      };
}
var t1 = r1;
function a1(u) {
...
var g1 = v1,
  ...
  _1 = (function () {
    try {
      var u = m1(Object, "defineProperty");
      return u({}, "", {}), u;
    } catch {}
  })(),
  x1 = _1,
...
var b1 = T1,
  S1 = Ue,
  $1 = S1(Object.getPrototypeOf, Object),
  ao = $1;
function w1(u) {
...
(function () {
  (ou.ast = ju), (ou.code = vu), (ou.keyword = Gu);
})();
var Du = {},
  X = {};
const V1 = "doctrine",
  J1 = "JSDoc parser",
  Q1 = "https://github.com/eslint/doctrine",
  Y1 = "lib/doctrine.js",
  X1 = "3.0.0",
  Z1 = { node: ">=6.0.0" },
  uA = { lib: "./lib" },
    ...
    return (
      ...
      n === e.DOT_LT || n === e.LT
        ? (M(),
          (D = Eu()),
          C(e.GT),
          d({ type: u.TypeApplication, expression: i, applications: D }, [
            y,
            s,
          ]))
        : i
    ...
    switch (n) {
      ...
      case e.NAME:
        ...
        if (l === "true" || l === "false")
          return (
            _(e.NAME),
            d({ type: u.BooleanLiteralType, value: l === "true" }, [D, s])
          );
      ...
      case e.STRING:
        return (
          M(), d({ type: u.StringLiteralType, value: l }, [s - l.length - 2, s])
        );
      case e.NUMBER:
        return (
          M(),
          d({ type: u.NumericLiteralType, value: l }, [s - String(l).length, s])
        );
      default:
        E.throwError("unexpected token");
    }
...
const { combineParameters: FA } = __STORYBOOK_MODULE_PREVIEW_API__;
var CA = (u) => {
    switch (u.type) {
      case "function":
  ...
  Fu = (u) => {
    ...
    switch ((typeof r < "u" && (t.raw = r), u.name)) {
      ...
      case "signature":
        return { ...t, ...EA(u) };
      case "union":
        return u.elements.every(lA)
          ? { ...t, name: "enum", value: u.elements.map(cA) }
    ...
    switch ((typeof r < "u" && (s.raw = r), e)) {
      case "enum": {
        let l = t
          ...
          : a.map((p) => {
              let E = pA(p.value);
              return fA(p.value) || Number.isNaN(Number(E)) ? E : Number(E);
            });
...
function gA(u, e) {
  return Xe(u) ? u.__docgenInfo[e] : null;
}
function mA(u) {
  return Xe(u) && dA(u.__docgenInfo.description);
}
function _A(u) {
...
var TA = {
  ...
  bA = (u, e = TA) => {
    if (!_A(u)) return { includesJsDoc: !1, ignore: !1 };
    let r = xA(u, e.tags),
      t = SA(r);
    return t.ignore
...
function ur({ name: u, value: e, elements: r, raw: t }) {
  return e ?? (r != null ? r.map(ur).join(" | ") : t ?? u);
}
function PA({ name: u, raw: e, elements: r }) {
  return r != null
    ? O(r.map(ur).join(" | "))
    : e != null
    ? O(e.replace(/^\|\s*/, ""))
...
function IA({ type: u, raw: e }) {
  return e != null ? O(e) : O(u);
}
function RA({ type: u, raw: e }) {
  return e != null ? (Ze(e) ? O(u, e) : O(e)) : O(u);
}
function LA(u) {
  let { type: e } = u;
  return e === "object" ? RA(u) : IA(u);
}
function MA({ name: u, raw: e }) {
  return e != null ? (Ze(e) ? O(u, e) : O(e)) : O(u);
}
function kA(u) {
...
function UA(u, e) {
  if (u != null) {
    let { value: r } = u;
    if (!Xu(r)) return NA(r) ? O(e.name, r) : O(r);
  }
  return null;
}
var jA = (u, e) => {
...
function GA({ tsType: u, required: e }) {
  return u == null ? null : O(e ? u.name : u.name.replace(" | undefined", ""));
}
function KA({ defaultValue: u }) {
  if (u != null) {
    let { value: e } = u;
    if (!Xu(e)) return O(e);
  }
...
function VA(u, e) {
  if (u != null) {
    let { value: r } = u;
    if (!Xu(r)) return WA(u) && zA(e) ? O(JSON.stringify(r)) : O(r);
  }
  return null;
}
function er(u, e, r) {
...
var JA = (u, e, r) => {
  ...
  uo = (u) => {
    ...
    return e
      .map((a) => {
        let s = u[a];
        return s != null ? ar(a, s, r, t) : null;
      })
      .filter(Boolean);
  },
  no = (u, e) => {
    let r = gA(u, e);
    return vA(r) ? (Array.isArray(r) ? ZA(r) : uo(r)) : [];
  };
function ar(u, e, r, t) {
  let a = bA(e.description);
...
//# sourceMappingURL=index-a517a563.js.map
