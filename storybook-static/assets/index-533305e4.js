import { _ as st } from "./iframe-edd50d93.js";
import { r as A, a as ii, R as a, c as X0, b as Q0 } from "./index-0e95cdc0.js";
import { s as fe } from "./index-d475d2ea.js";
import { L as Nl, v as ec } from "./index-d37d4223.js";
import {
  n as Vl,
  o as tc,
  p as zl,
...
const { logger: Ac } = __STORYBOOK_MODULE_CLIENT_LOGGER__;
...
function ya(e) {
  ...
  return (
    (ya = function (r) {
      ...
      function n() {
        return Ur(r, arguments, ba(this).constructor);
      }
      return (
...
var Je = (function (e) {
  ...
  function t(r) {
    for (
      ...
      i[l - 1] = arguments[l];
    return (
      (n = e.call(this, Mc.apply(void 0, [Dc[r]].concat(i))) || this), Fc(n)
    );
  }
  return t;
})(ya(Error));
...
function hr(e, t, r, n) {
  if ((n === void 0 && (n = Lc), t === 0)) return n(r, r, r);
...
function gn(e) {
  ...
  var i = Zc.exec(t.substring(0, 50));
  if (i)
    return {
      red: parseInt("" + i[1], 10),
  ...
  var g = Nc.exec(t.substring(0, 50));
  if (g) {
...
function Xc(e, t) {
  ...
  var r = rs(t);
  return ns(yt({}, r, { lightness: bn(0, 1, r.lightness - parseFloat(e)) }));
}
var Qc = hn(Xc),
  e1 = Qc;
function t1(e, t) {
...
const Mt = Aa,
  { logger: E1 } = __STORYBOOK_MODULE_CLIENT_LOGGER__;
var x1 = Ja({
...
function ir(e, t) {
  return T1(En("", null, null, "", null, null, 0), e, { length: -e.length }, t);
}
function B1() {
  return ae;
}
...
function Ce() {
  return (
    (ae = we < ds ? ue(Jt, we++) : 0), Vt++, ae === 10 && ((Vt = 1), vn++), ae
  );
}
function et() {
  return ue(Jt, we);
...
function ps(e) {
  return (vn = Vt = 1), (ds = Ge((Jt = e))), (we = 0), [];
}
function fs(e) {
  return (Jt = ""), e;
}
function Gr(e) {
  return cs(Tr(we - 1, Sa(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function I1(e) {
  for (; (ae = et()) && ae < 33; ) Ce();
...
function P1(e) {
  return fs(Yr("", null, null, null, [""], (e = ps(e)), 0, [0], e));
}
  ...
  for (
    ...
    switch (((m = S), (S = Ce()))) {
      ...
      default:
        if (f < 1) {
          if (S == 123) --f;
          else if (S == 125 && f++ == 0 && $1() == 125) continue;
        }
        switch (((k += yn(S)), S * f)) {
          case 38:
            b = p > 0 ? 1 : ((k += "\f"), -1);
...
function ci(e, t, r, n, o, i, l, u, s, c, p) {
  for (
    ...
    for (var b = 0, S = yr(e, h + 1, (h = R1((f = l[m])))), v = e; b < d; ++b)
      (v = cs(f > 0 ? g[b] + " " + S : G(S, /&\f/g, g[b]))) && (s[y++] = v);
  return En(e, t, r, o === 0 ? to : u, s, c, p);
}
function N1(e, t, r) {
  return En(e, t, r, eo, yn(B1()), yr(e, 2, -2), 0);
}
function di(e, t, r, n) {
  return En(e, t, r, ro, yr(e, 0, n), yr(e, n + 1, -1), n);
}
function Nt(e, t) {
...
var q1 = function (e) {
  ...
  W1 = function (e, t) {
    ...
    do
      switch (vr(n)) {
        case 0:
          n === 38 && et() === 12 && (t[r] = 1), (e[r] += U1(we - 1, t, r));
          break;
        case 2:
          e[r] += Gr(n);
          break;
  ...
  Y1 = function (e) {
    if (!(e.type !== "rule" || !e.parent || e.length < 1)) {
      ...
      if (
        ...
        for (
          var o = [], i = G1(t, o), l = r.props, u = 0, s = 0;
          u < i.length;
          u++
        )
  ...
  X1 = function (e) {
    return e.type === "comm" && e.children.indexOf(J1) > -1;
  },
  Q1 = function (e) {
  ...
  ed = function (e, t) {
    for (var r = e - 1; r >= 0; r--) if (!ms(t[r])) return !0;
    return !1;
  },
  mi = function (e) {
    (e.type = ""),
    ...
    case 4765:
      if (Ge(e) - 1 - t > 6)
        switch (ue(e, t + 1)) {
          ...
          case 115:
            return ~wa(e, "stretch")
              ? gs(G(e, "stretch", "fill-available"), t) + e
              : e;
        }
      break;
    case 4949:
...
var rd = function (e, t, r, n) {
    if (e.length > -1 && !e.return)
      switch (e.type) {
        case ro:
          e.return = gs(e.value, e.length);
          break;
        case us:
          return Nt([ir(e, { value: G(e.value, "@", "@" + W) })], n);
        case to:
          if (e.length)
            return L1(e.props, function (o) {
...
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#ES2018_revision_of_illegal_escape_sequences`,
  ...
  Wn = ss(function (e) {
    return oo(e) ? e : e.replace(pd, "-$&").toLowerCase();
  }),
  sn = function (e, t) {
    switch (e) {
      case "animation":
      case "animationName":
        if (typeof t == "string")
          return t.replace(hs, function (r, n, o) {
            return (Ye = { name: n, styles: o, next: Ye }), n;
          });
    }
    return cd[e] !== 1 && !oo(e) && typeof t == "number" && t !== 0
      ? t + "px"
      : t;
  };
(bi =
...
function Er(e, t, r) {
  ...
  if (r.__emotion_styles !== void 0) {
    if (r.toString() === "NO_COMPONENT_SELECTOR") throw new Error(bs);
    return r;
  }
  switch (typeof r) {
    case "boolean":
  ...
  if (Array.isArray(r))
    ...
    for (var i in r) {
      ...
      if (typeof l != "object")
        ...
        if (i === "NO_COMPONENT_SELECTOR") throw new Error(bs);
        if (
          Array.isArray(l) &&
          typeof l[0] == "string" &&
          (t == null || t[l[0]] === void 0)
          ...
          switch (i) {
            ...
            default:
              i === "undefined" && console.error(dd), (n += i + "{" + s + "}");
          }
        }
      }
    }
...
var wi = /label:\s*([^\s;\n{]+)\s*(;|$)/g,
  ys;
ys = /\/\*#\ssourceMappingURL=data:application\/json;\S+\s+\*\//g;
var Ye,
  zt = function (e, t, r) {
    if (
      e.length === 1 &&
  ...
  md = {}.hasOwnProperty,
  io = A.createContext(typeof HTMLElement < "u" ? od({ key: "css" }) : null);
...
var gd = function () {
  ...
  vd = wn(function (e, t, r) {
    ...
    var c = {};
    for (var p in e)
      md.call(e, p) && p !== "css" && p !== Si && p !== Ci && (c[p] = e[p]);
    return (
      (c.ref = r),
      (c.className = l),
      A.createElement(
...
vd.displayName = "EmotionCssPropInternal";
ts(ls());
var Ed = {
    name: "@emotion/react",
    version: "11.10.6",
  ...
  Cd = wn(function (e, t) {
    ...
    return (
      ...
      A.createElement(
        A.Fragment,
        null,
        A.createElement(Sd, { cache: t, serializedArr: n }),
        u
      )
    );
  });
Cd.displayName = "EmotionClassNames";
(Yn = !0),
  (_i = typeof jest < "u" || typeof vi < "u"),
  Yn &&
    !_i &&
    ((Kn = typeof globalThis < "u" ? globalThis : Yn ? window : global),
    (Jn = "__EMOTION_REACT_" + Ed.version.split(".")[0] + "__"),
    Kn[Jn] &&
      console.warn(
...
var Yn,
  ...
  Fi = function (e) {
    return typeof e == "string" && e.charCodeAt(0) > 96 ? kd : _d;
  },
  Oi = function (e, t, r) {
    var n;
    if (t) {
...
var Md = { rubber: "cubic-bezier(0.175, 0.885, 0.335, 1.05)" },
  Ld = Xt`
	from {
...
`,
  ...
  Nd = (e) =>
    Object.entries(e).reduce((t, [r, n]) => ({ ...t, [r]: f1(n) }), {}),
  Vd = ({ colors: e, mono: t }) => {
    let r = Nd(e);
    return {
      token: {
  ...
  ka = (e = xa[os()]) => {
    ...
    return {
      ...
      code: Vd({ colors: t === "light" ? zd : qd, mono: c }),
      addonActionsTheme: {
        ...(t === "light" ? Pd : Zd),
        BASE_FONT_FAMILY: c,
  ...
  Wd = (e) => Object.keys(e).length === 0,
  Xn = (e) => e != null && typeof e == "object",
  Gd = (e, ...t) => Object.prototype.hasOwnProperty.call(e, ...t),
  ...
  Dp = P({
    "../../node_modules/parse-entities/index.js"(e, t) {
      ...
      function re(I, z) {
        ...
        function J0(ai, oi) {
          var Pn = or();
          (Pn.column += oi), (Pn.offset += oi), Fe.call(Be, Z[ai], Pn, ai);
        }
        function ni() {
          Ne &&
            ($t.push(Ne),
...
const { logger: Hp } = __STORYBOOK_MODULE_CLIENT_LOGGER__;
var Zp = _e(Cs()),
  Pp = Zp.default,
  Np = _e(Bp()),
  Vp = Np.default,
    ...
    if (!i) g = Zt(Zt({}, u), {}, { className: Di(u.className) });
      ...
      g = Zt(
        ...
        {},
        {
          ...
          style: y2(u.className, Object.assign({}, u.style, o), r),
        }
      );
    }
    var y = h(t.children);
...
function $s(e) {
  for (
    ...
    var o = e[n];
    if (o.type === "text")
      r.push(Kr({ children: [o], className: f2(new Set(t)) }));
    else if (o.children) {
      var i = t.concat(o.properties.className);
      $s(o.children, i).forEach(function (l) {
        return r.push(l);
      });
    }
  }
...
function R2(e, t) {
  return function (r) {
    ...
    ((w === void 0 && R) || C) && (w = !0), (R = R || F2);
    var J = [{ type: "text", value: H }],
      I = O2({ astGenerator: V, language: n, code: H, defaultCodeValue: J });
    I.language === null && (I.value = J);
    var z = I.value.length + S,
      U = _2(I, w, O, m, y, S, z, x, C);
    return a.createElement(
      T,
      Y,
      a.createElement(
...
var go = ({ actionItems: e, ...t }) =>
  ...
  D2 = A.lazy(() =>
    st(
      () => import("./GlobalScrollAreaStyles-XIHNDKUY-9db02528.js"),
      [
        "./GlobalScrollAreaStyles-XIHNDKUY-9db02528.js",
        "./index-0e95cdc0.js",
  ...
  M2 = A.lazy(() =>
    st(
      () => import("./OverlayScrollbars-VAV6LJAB-efe39de8.js"),
      [
        "./OverlayScrollbars-VAV6LJAB-efe39de8.js",
        "./index-0e95cdc0.js",
        "./_commonjsHelpers-725317a4.js",
        "./iframe-edd50d93.js",
        "./index-d475d2ea.js",
  ...
  L2 = ({ horizontal: e, vertical: t, ...r }) =>
    a.createElement(
      A.Suspense,
      { fallback: a.createElement("div", { ...r }) },
      a.createElement(D2, null),
      a.createElement(M2, {
...
var { navigator: Pr, document: lr, window: B2 } = fe;
Me.registerLanguage("jsextra", Wp);
Me.registerLanguage("jsx", Pp);
Me.registerLanguage("json", Yp);
Me.registerLanguage("yml", n2);
Me.registerLanguage("md", t2);
Me.registerLanguage("bash", Vp);
Me.registerLanguage("css", qp);
Me.registerLanguage("html", Qp);
Me.registerLanguage("tsx", o2);
Me.registerLanguage("typescript", l2);
Me.registerLanguage("graphql", Jp);
var $2 = Mt(2)((e) =>
...
var j2 = _.div(
  ...
  H2 = ({ children: e, className: t }) =>
    a.createElement(Sn, { horizontal: !0, vertical: !0, className: t }, e),
  Z2 = _(H2)({ position: "relative" }, ({ theme: e }) => $2(e)),
  P2 = _.pre(({ theme: e, padded: t }) => ({
    display: "flex",
  ...
  V2 = ({ rows: e, stylesheet: t, useInlineStyles: r }) =>
    e.map((n, o) =>
      po({
        node: Zs(n),
        stylesheet: t,
  ...
  z2 = (e, t) =>
    t
      ? e
        ? ({ rows: r, ...n }) => e({ rows: r.map((o) => Zs(o)), ...n })
        : V2
      : e,
  Ps = ({
    children: e,
  ...
  Vs = [].concat(Mr, [Cn]).reduce(function (e, t) {
...
function Lr(e) {
  for (var t = ke(e), r = Ii(e); r && l5(r) && ut(r).position === "static"; )
    r = Ii(r);
  return r &&
...
function p5(e) {
  ...
  if (
    ...
    if (!qs(t.elements.popper, o)) return;
    t.elements.arrow = o;
  }
}
var f5 = {
...
function ji(e) {
  ...
  var R = Object.assign({ position: u }, c && m5),
    M = p === !0 ? g5({ x: d, y: f }, ke(r)) : { x: d, y: f };
  if (((d = M.x), (f = M.y), s)) {
    var T;
...
var v5 = {
  ...
  E5 = { left: "right", right: "left", bottom: "top", top: "bottom" };
function Jr(e) {
...
function Zi(e, t, r) {
  return t === Ns ? Ra(A5(e, r)) : Dt(t) ? S5(t, r) : Ra(w5(Et(e)));
}
function C5(e) {
  var t = fr(kn(e)),
  ...
  return Dt(n)
    ? t.filter(function (o) {
        return Dt(o) && qs(o, n) && rt(o) !== "body";
      })
    : [];
}
function k5(e, t, r, n) {
  var o = t === "clippingParents" ? C5(e) : [].concat(t),
    i = [].concat(o, [r]),
    l = i[0],
...
function wr(e, t) {
  ...
  var r = t,
    ...
    f = r.padding,
    y = f === void 0 ? 0 : f,
    b = Ws(typeof y != "number" ? y : Gs(y, Mr)),
    S = g === sr ? W2 : sr,
    v = e.rects.popper,
    E = e.elements[m ? S : g],
    x = k5(Dt(E) ? E : E.contextElement || Et(e.elements.popper), s, p, l),
    w = Wt(e.elements.reference),
    k = Ks({ reference: w, element: v, strategy: "absolute", placement: o }),
...
function L5(e) {
  var t = e.state,
    ...
    o = r.offset,
    i = o === void 0 ? [0, 0] : o,
    l = Vs.reduce(function (p, h) {
      return (p[h] = M5(h, t.rects, i)), p;
    }, {}),
    u = l[t.placement],
    s = u.x,
    c = u.y;
  ...
  if (w) {
    ...
    if (u) {
      var Bt,
        ...
        $e = d && Ve ? u5(ze, ge, de) : pr(d ? ze : Ne, ge, d ? de : $t);
      (w[x] = $e), (M[x] = $e - ge);
    }
    t.modifiersData[n] = M;
  }
    ...
    var c = {
      ...
      g = {
        ...
        setOptions: function (f) {
          ...
          var b = U5(G5([].concat(n, c.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!h) {
            ...
            if (!zi(y, b)) return;
            (c.rects = {
              reference: z5(y, Lr(b), c.options.strategy === "fixed"),
              popper: bo(b),
            }),
              (c.reset = !1),
...
var K5 = [v5, I5, b5, i5, B5, R5, Z5, f5, D5],
  J5 = Y5({ defaultModifiers: K5 }),
  X5 = _e(q2()),
  Q5 = [],
  ef = function (e, t, r) {
    r === void 0 && (r = {});
    var n = A.useRef(null),
      ...
      c = A.useMemo(
        function () {
          ...
          return (0, X5.default)(n.current, h)
            ? n.current || h
            : ((n.current = h), h);
        },
...
var nf = ["styles", "attributes"],
  qi = { getBoundingClientRect: Xs() },
  Ui = {
...
function af(e, t) {
  ...
  var S = ef(i.followCursor ? qi : c, g, u),
    v = S.styles,
    E = S.attributes,
    x = so(S, nf),
    w = x.update,
    k = Js({ visible: f, triggerRef: c, tooltipRef: g, finalConfig: i }),
    C = A.useCallback(
      function (D) {
    ...
    A.useEffect(
      function () {
        ...
        function D(L) {
          var H = L.clientX,
            V = L.clientY;
          (qi.getBoundingClientRect = Xs(H, V)), w == null || w();
        }
        return (
  ...
  Ao = a.forwardRef(
    (
      ...
      a.createElement(
        ...
        t && l && a.createElement(of, { placement: e, ...n, color: i }),
        r
      )
  );
...
var cf = ({ startOpen: e = !1, onVisibleChange: t, ...r }) => {
  ...
  return (
    ...
    a.createElement(Qs, { ...r, visible: n, onVisibleChange: i })
  );
};
function df(e, t) {
  var r = A.useRef(null),
...
function Cr(e, t, r, n) {
  if ((n === void 0 && (n = hf), t === 0)) return n(r, r, r);
  var o = (((e % 360) + 360) % 360) / 60,
    i = (1 - Math.abs(2 * r - 1)) * t,
    l = i * (1 - Math.abs((o % 2) - 1)),
    u = 0,
...
function wo(e) {
  ...
  var i = Af.exec(t.substring(0, 50));
  if (i)
    return {
      red: parseInt("" + i[1], 10),
      green: parseInt("" + i[2], 10),
  ...
  var g = Sf.exec(t.substring(0, 50));
  if (g) {
    var d = parseInt("" + g[1], 10),
      m = parseInt("" + g[2], 10) / 100,
      f = parseInt("" + g[3], 10) / 100,
...
function Lf(e, t) {
  if (t === "transparent") return t;
  var r = tu(t);
  return ru(be({}, r, { lightness: Co(0, 1, r.lightness - parseFloat(e)) }));
}
var Bf = So(Lf),
  Pt = Bf;
function $f(e, t) {
...
var Zf = So(Hf),
  ...
  ko = ({ className: e, children: t, ...r }) => {
    ...
    return o.filter(Nf).some((i) => i.match(Vf))
      ? a.createElement(
          qf,
          {
            bordered: !0,
      ...
      : a.createElement(zf, { ...r, className: e }, o);
  },
  iu = _.div(te),
  lu = _.dl(te, {
    ...Lt,
  ...
  uu = _.h4(te, Qt, ({ theme: e }) => ({
    fontSize: `${e.typography.size.s3}px`,
  })),
  cu = _.h5(te, Qt, ({ theme: e }) => ({
    fontSize: `${e.typography.size.s2}px`,
  })),
  du = _.h6(te, Qt, ({ theme: e }) => ({
    fontSize: `${e.typography.size.s2}px`,
    color: e.color.dark,
  })),
  pu = _.hr(({ theme: e }) => ({
  ...
  gu = _.ol(te, Lt, { ...Uf, listStyle: "decimal" }),
  hu = _.p(te, Lt, ({ theme: e }) => ({
    fontSize: e.typography.size.s2,
    lineHeight: "24px",
    color: e.color.defaultText,
    "& code": ct({ theme: e }),
  })),
  bu = _.pre(te, Lt, ({ theme: e }) => ({
    fontFamily: e.typography.fonts.mono,
    WebkitFontSmoothing: "antialiased",
    MozOsxFontSmoothing: "grayscale",
    lineHeight: "18px",
  ...
  xu = _.ul(te, Lt, { ...Wf, listStyle: "disc" }),
  Oo = _.div(te),
  Au = {
    h1: (e) => a.createElement(su, { ...Q(e, "h1") }),
    h2: (e) => a.createElement(_o, { ...Q(e, "h2") }),
    h3: (e) => a.createElement(Fo, { ...Q(e, "h3") }),
    h4: (e) => a.createElement(uu, { ...Q(e, "h4") }),
    h5: (e) => a.createElement(cu, { ...Q(e, "h5") }),
    h6: (e) => a.createElement(du, { ...Q(e, "h6") }),
    pre: (e) => a.createElement(bu, { ...Q(e, "pre") }),
    a: (e) => a.createElement(au, { ...Q(e, "a") }),
    hr: (e) => a.createElement(pu, { ...Q(e, "hr") }),
    dl: (e) => a.createElement(lu, { ...Q(e, "dl") }),
    blockquote: (e) => a.createElement(ou, { ...Q(e, "blockquote") }),
    table: (e) => a.createElement(vu, { ...Q(e, "table") }),
    img: (e) => a.createElement(fu, { ...Q(e, "img") }),
    div: (e) => a.createElement(iu, { ...Q(e, "div") }),
    span: (e) => a.createElement(yu, { ...Q(e, "span") }),
    li: (e) => a.createElement(mu, { ...Q(e, "li") }),
    ul: (e) => a.createElement(xu, { ...Q(e, "ul") }),
    ol: (e) => a.createElement(gu, { ...Q(e, "ol") }),
    p: (e) => a.createElement(hu, { ...Q(e, "p") }),
    code: (e) => a.createElement(ko, { ...Q(e, "code") }),
    tt: (e) => a.createElement(Eu, { ...Q(e, "tt") }),
...
`,
  ...
  Kf = A.memo(function ({ icons: e = Object.keys(kr) }) {
    return a.createElement(
      wu,
      {
        viewBox: "0 0 14 14",
  ...
  Jf = 0,
  Xf = (e) =>
    e.button === Jf && !e.altKey && !e.ctrlKey && !e.metaKey && !e.shiftKey,
  Qf = (e, t) => {
    Xf(e) && (e.preventDefault(), t(e));
  },
  em = _.span(
    ({ withArrow: e }) =>
      e
  ...
  _r = ({
    ...
    a.createElement(
      tm,
      { ...l, onClick: r && e ? (u) => Qf(u, r) : r, className: i },
      a.createElement(
        em,
...
var rm = _.div(({ theme: e }) => ({
  ...
  nm = A.lazy(() =>
    st(
      () => import("./syntaxhighlighter-QTQ2UBB4-bbfcb220.js"),
      [
        "./syntaxhighlighter-QTQ2UBB4-bbfcb220.js",
        "./iframe-edd50d93.js",
        "./index-0e95cdc0.js",
        "./_commonjsHelpers-725317a4.js",
        "./index-d475d2ea.js",
  ...
  am = A.lazy(async () => {
    let [{ SyntaxHighlighter: e }, { formatter: t }] = await Promise.all([
      ...
      st(
        () => import("./formatter-S4K5WUZV-025a524b.js"),
        [
          "./formatter-S4K5WUZV-025a524b.js",
          "./iframe-edd50d93.js",
          "./index-0e95cdc0.js",
          "./_commonjsHelpers-725317a4.js",
          "./index-d475d2ea.js",
  ...
  Ro = (e) =>
    a.createElement(
      ...
      e.format !== !1
        ...
        : a.createElement(nm, { ...e })
    ),
  om = (e) => (typeof e == "number" ? e : Number(e)),
  im = _.div(
  ...
  lm = ({ col: e, row: t, outer: r, children: n, ...o }) => {
    let i = om(typeof r == "number" || !r ? r : e || t);
    return a.createElement(im, { col: e, row: t, outer: i, ...o }, n);
  },
  sm = _.div(({ theme: e }) => ({ fontWeight: e.typography.weight.bold })),
  um = _.div(),
  cm = _.div(({ theme: e }) => ({
    padding: 30,
    textAlign: "center",
  ...
  Su = ({ children: e, ...t }) => {
    ...
    return a.createElement(
      cm,
      { ...t },
      a.createElement(sm, null, r),
      n && a.createElement(um, null, n)
    );
  };
function Cu() {
  var e;
...
var ku = Cu(),
  dm = _.div(({ scale: e = 1, elementHeight: t }) =>
    ku
      ? { "> *": { zoom: 1 / e } }
      : {
          height: t || "auto",
...
function pm({ scale: e, children: t }) {
  ...
  return (
    ...
    a.createElement(
      ...
      a.createElement(
        "div",
        { ref: ku ? null : r, className: "innerZoomElementWrapper" },
        t
      )
    )
  );
}
var fm = class extends A.Component {
    constructor() {
  ...
  _u = { Element: pm, IFrame: fm },
  { document: mm } = fe,
  gm = _.strong(({ theme: e }) => ({ color: e.color.orange })),
  hm = _.strong(({ theme: e }) => ({
...
${t}`);
      ...
      l.map((u, s) =>
        u.name
          ? a.createElement(
              ...
              "  ",
              "at ",
              a.createElement(hm, null, u.name),
              " (",
  ...
  xm = Ou.withComponent("a"),
  Ru = Object.assign(
    A.forwardRef(function ({ isLink: e, children: t, ...r }, n) {
      return e
        ? a.createElement(xm, { ...r, ref: n }, t)
        : a.createElement(Ou, { ...r, ref: n }, t);
    }),
  ...
  Tu = ({ label: e, children: t, ...r }) =>
    a.createElement(
      Am,
      { ...r },
      e ? a.createElement(wm, null, a.createElement("span", null, e)) : null,
      t
    );
Tu.defaultProps = { label: void 0 };
var Sm = typeof document < "u" ? A.useLayoutEffect : A.useEffect,
  Cm = Sm,
  km = function (e) {
    var t = A.useRef(e);
    return (
...
var el = function () {},
  ...
  Dm = typeof document < "u" ? !!document.documentElement.currentStyle : !1,
  Mm = function (e) {
...
var Lm = function (e) {
  ...
  Bm = function (e) {
    Du(document.fonts, "loadingdone", e);
  },
  $m = [
    "cacheMeasurements",
    "maxRows",
  ...
  Im = function (e, t) {
    var r = e.cacheMeasurements,
      ...
      f = function () {
        var b = h.current,
          S = r && m.current ? m.current : Mm(b);
        if (S) {
          m.current = S;
          var v = Om(S, b.value || b.placeholder || "x", o, n),
            E = v[0],
            x = v[1];
          d.current !== E &&
            ((d.current = E),
    ...
    return (
      typeof document < "u" && (A.useLayoutEffect(f), Lm(f), Bm(f)),
  ...
  Vm = Object.assign(
    _(
      A.forwardRef(function ({ size: e, valid: t, align: r, ...n }, o) {
        return a.createElement(Hm, { ...n, ref: o });
      })
    )(To, _n, Mu, Fn, ({ height: e = 400 }) => ({
      overflow: "visible",
      maxHeight: e,
    })),
  ...
  zm = _(
    A.forwardRef(function ({ size: e, valid: t, align: r, ...n }, o) {
      return a.createElement(Ru, { ...n, ref: o });
    })
  )(_n, Fn, {
    userSelect: "none",
    overflow: "visible",
  ...
  Um = A.lazy(() =>
    st(
      () => import("./WithTooltip-FBT32F6Q-a8d57db2.js"),
      [
        "./WithTooltip-FBT32F6Q-a8d57db2.js",
        "./iframe-edd50d93.js",
        "./index-0e95cdc0.js",
        "./_commonjsHelpers-725317a4.js",
        "./index-d475d2ea.js",
  ...
  Lu = (e) =>
    a.createElement(
      A.Suspense,
      { fallback: a.createElement("div", null) },
      a.createElement(Gm, { ...e })
    ),
  Ym = _.div(({ theme: e }) => ({ fontWeight: e.typography.weight.bold })),
  Km = _.span(),
  Jm = _.div(({ theme: e }) => ({
    marginTop: 8,
    textAlign: "center",
  ...
  Qm = _.div({ padding: 15, width: 280, boxSizing: "border-box" }),
  Bu = ({ title: e, desc: t, links: r }) =>
    a.createElement(
      ...
      a.createElement(
        Xm,
        null,
        e && a.createElement(Ym, null, e),
        t && a.createElement(Km, null, t)
      ),
      r &&
        a.createElement(
          Jm,
...
var eg = _.div(({ theme: e }) => ({
  ...
  tg = ({ note: e, ...t }) => a.createElement(eg, { ...t }, e),
  rg = _(({ active: e, loading: t, disabled: r, ...n }) =>
    ...
    return a.createElement(
      ...
      r || n
        ? a.createElement(
            ag,
            { isIndented: !t && !i && s },
            r && a.createElement(rg, { ...m, loading: e }, r),
            n && a.createElement(og, { ...m }, n)
          )
        : null,
      o && a.createElement(ng, { ...m }, o)
    );
  };
$u.defaultProps = {
  loading: !1,
...
var cg = _.div(({ theme: e }) => ({
    width: 14,
    height: 14,
    backgroundColor: e.appBorderColor,
    animation: `${e.animation.glow} 1.5s ease-in-out infinite`,
  })),
  dg = _.div(() => ({ marginTop: 6, padding: 7, height: 28 })),
  Iu = () => a.createElement(dg, null, a.createElement(cg, null)),
  Ba = _.div(
    {
      display: "flex",
      whiteSpace: "nowrap",
...
Ba.displayName = "Side";
var pg = ({ children: e, className: t, scrollable: r }) =>
    r
...
var Eg = _.div(
  ...
  xg = ({ active: e, render: t, children: r }) =>
    a.createElement(ju, { active: e }, t ? t() : r),
  Rn = A.memo(
    ({
      children: e,
      selected: t,
      ...
      let c = A.useMemo(() => mg(e, t), [e, t]),
        { visibleList: p, tabBarRef: h, tabRefs: g, AddonTab: d } = bg(c);
      return c.length
        ? a.createElement(
            vg,
...
var Hu = class extends A.Component {
  constructor(e) {
    super(e),
...
var Ag = (e) =>
  ...
  Cg = ({ active: e, children: t }) =>
    a.createElement("div", { hidden: !e }, Sg(e, t)),
  kg = ({ alt: e, ...t }) =>
    a.createElement(
      "svg",
      {
...
`,
  ...
  Zu = ({ progress: e, error: t, size: r, ...n }) => {
    if (t)
      return a.createElement(
        rl,
        {
        ...
        a.createElement(Dg, { icon: "lightningoff" }),
      ...
      return (
        ...
        a.createElement(
          ...
          a.createElement(
            Rg,
            null,
            a.createElement(Tg, { style: { width: `${o * 100}%` } })
          ),
          a.createElement(nl, null, l, o < 1 && a.createElement(Lg, { key: l }))
        )
      );
    }
    return a.createElement(Og, {
      "aria-label": "Content is loading...",
      "aria-live": "polite",
      role: "status",
      size: r,
...
Object.keys(Au).forEach((e) => {
  Vu[e] = A.forwardRef((t, r) => A.createElement(e, { ...t, ref: r }));
});
...
function Tn(e) {
  ...
  var i = Wg.exec(t.substring(0, 50));
  if (i)
    return {
      red: parseInt("" + i[1], 10),
      green: parseInt("" + i[2], 10),
  ...
  var g = Yg.exec(t.substring(0, 50));
  if (g) {
    var d = parseInt("" + g[1], 10),
      m = parseInt("" + g[2], 10) / 100,
      f = parseInt("" + g[3], 10) / 100,
...
function Uu(e, t, r) {
  return function () {
    ...
    return o.length >= t ? e.apply(this, o) : Uu(e, t, o);
  };
}
function Dn(e) {
  return Uu(e, e.length, []);
}
function Mn(e, t, r) {
  return Math.max(e, Math.min(t, r));
}
function oh(e, t) {
  if (t === "transparent") return t;
  var r = zu(t);
  return qu(Yt({}, r, { lightness: Mn(0, 1, r.lightness - parseFloat(e)) }));
}
var ih = Dn(oh),
  We = ih;
function lh(e, t) {
...
var ph = Dn(dh),
  ...
  mh = tc,
  gh = Object.prototype,
  hh = gh.hasOwnProperty;
function bh(e, t, r) {
  var n = e[t];
  (!(hh.call(e, t) && mh(n, r)) || (r === void 0 && !(t in e))) && fh(e, t, r);
}
var jo = bh,
  yh = jo,
  vh = zl,
...
var $h = Bh,
  ...
  Hh = $h,
  Zh = Object.prototype,
  Ph = Zh.hasOwnProperty;
function Nh(e) {
  if (!Ih(e)) return Hh(e);
  var t = jh(e),
    r = [];
  for (var n in e) (n == "constructor" && (t || !Ph.call(e, n))) || r.push(n);
  return r;
}
var Vh = Nh,
  zh = lc,
...
const Kb = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,
  Jb = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,
  p0 = [Yu, Ku, Ju, Xu, Qu, e0, t0, l0, c0, s0, d0],
  Xb = [...p0, /^[^\n]+(?: {2}\n|\n{2,})/, Za, Pa];
function Qb(e) {
  return e
...
function iy(e, t = {}) {
  ...
  function n(d, m, ...f) {
    ...
    return r(
      ...
      Ot({}, m, y, {
        className: oy(m == null ? void 0 : m.className, y.className) || void 0,
      }),
      ...f
    );
  }
  function o(d) {
    let m = !1;
    t.forceInline ? (m = !0) : t.forceBlock || (m = Rb.test(d) === !1);
    const f = p(
      c(
        m
          ? d
          : `${d.trimEnd().replace(zb, "")}
...
`,
            ...
            const v = (function (k) {
              ...
              w = (f[x] = (function (k, C) {
                return k === "style"
                  ...
                  : k === "href"
                  ? jt(C)
                  : (C.match(xb) && (C = C.slice(1, C.length - 1)),
                    C === "true" || (C !== "false" && C));
              })(v, E));
            typeof w == "string" &&
              (Za.test(w) || Pa.test(w)) &&
  ...
  const l = [],
    ...
    s = {
      ...
      htmlComment: { t: ur(e0), i: q.HIGH, l: () => ({}), h: sa },
      image: {
        t: ft(Jb),
        i: q.HIGH,
      ...
      link: {
        t: pt(Kb),
        i: q.LOW,
        l: (d, m, f) => ({ $: ny(m, d[1], f), R: pl(d[2]), N: d[3] }),
        h: (d, m, f) =>
...
`,
  ...
  t.disableParsingRawHTML !== !0 &&
    ((s.htmlBlock = {
      ...
      i: q.HIGH,
      l(d, m, f) {
        const [, y] = d[3].match(qb),
          b = new RegExp(`^${y}`, "gm"),
          S = d[3].replace(b, ""),
          v = ((E = S), Xb.some((C) => C.test(E)) ? ay : tn);
        var E;
...
const f0 = (e) => {
  ...
  return A.cloneElement(iy(t, r), n);
};
function ly(e, t, r, n) {
...
function rn(e, t, r, n, o, i) {
  ...
  return (
    _4(f || e, function (y, b) {
      f && ((b = y), (y = e[b])), F4(l, b, rn(y, t, r, b, e, i));
    }),
    l
  );
}
...
var k7 = Object.create,
  ...
  _7 = Object.getOwnPropertyDescriptor,
  y0 = Object.getOwnPropertyNames,
  F7 = Object.getPrototypeOf,
    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let o of y0(t))
        !O7.call(e, o) &&
          ...
          b0(e, o, {
            get: () => t[o],
            enumerable: !(n = _7(t, o)) || n.enumerable,
          });
    return e;
  },
  Vo = (e, t, r) => (
    ...
    R7(
      t || !e || !e.__esModule
        ? b0(r, "default", { value: e, enumerable: !0 })
        : r,
      e
    )
  ),
  ...
  D7 = ["detail"];
function M7(e) {
  const t = T7.filter((r) => e[r] !== void 0).reduce(
    (r, n) => ({ ...r, [n]: e[n] }),
    {}
  );
  return (
    e instanceof CustomEvent &&
      D7.filter((r) => e[r] !== void 0).forEach((r) => {
        t[r] = e[r];
      }),
    t
  );
...
var U7 =
  ...
  W7 = U7,
  G7 = typeof self == "object" && self && self.Object === Object && self,
  Y7 = W7 || G7 || Function("return this")(),
  qo = Y7,
  K7 = qo.Symbol,
  Kt = K7,
  A0 = Object.prototype,
  J7 = A0.hasOwnProperty,
  X7 = A0.toString,
...
var w0 = uv,
  cv = "[object AsyncFunction]",
  dv = "[object Function]",
  pv = "[object GeneratorFunction]",
  fv = "[object Proxy]";
function mv(e) {
  if (!w0(e)) return !1;
  var t = sv(e);
  return t == dv || t == pv || t == cv || t == fv;
}
var gv = mv,
  hv = qo["__core-js_shared__"],
  da = hv,
  kl = (function () {
...
function Yv(e) {
  var t = this.__data__;
  return Rr ? t[e] !== void 0 : Gv.call(t, e);
}
var Kv = Yv,
  Jv = "__lodash_hash_undefined__";
function Xv(e, t) {
  var r = this.__data__;
  return (
    (this.size += this.has(e) ? 0 : 1),
    (r[e] = Rr && t === void 0 ? Jv : t),
    this
  );
}
var Qv = Xv;
...
er.prototype.clear = Hv;
er.prototype.delete = Pv;
er.prototype.get = Uv;
er.prototype.has = Kv;
er.prototype.set = Qv;
var _l = er;
...
tr.prototype.clear = t6;
tr.prototype.delete = i6;
tr.prototype.get = s6;
tr.prototype.has = c6;
tr.prototype.set = p6;
var f6 = tr,
...
function E6(e, t) {
  var r = e.__data__;
  return v6(t) ? r[typeof t == "string" ? "string" : "hash"] : r.map;
}
var $n = E6;
function x6(e) {
...
rr.prototype.clear = b6;
rr.prototype.delete = A6;
rr.prototype.get = S6;
rr.prototype.has = k6;
rr.prototype.set = F6;
var C0 = rr,
  O6 = "Expected a function";
function Uo(e, t) {
  if (typeof e != "function" || (t != null && typeof t != "function"))
    throw new TypeError(O6);
  var r = function () {
    var n = arguments,
  ...
  return (r.cache = new (Uo.Cache || C0)()), r;
}
Uo.Cache = C0;
var R6 = Uo,
  T6 = 500;
function D6(e) {
  var t = R6(e, function (n) {
      return r.size === T6 && r.clear(), n;
    }),
    r = t.cache;
  return t;
}
...
M6(function (e) {
  ...
  return (
    ...
    e.replace(L6, function (r, n, o, i) {
      t.push(o ? i.replace(B6, "$1") : n || r);
    }),
    t
  );
});
...
function k0(e) {
  ...
  let t = e,
    r = !1;
  return (
    typeof Event < "u" && e instanceof Event && ((t = M7(t)), (r = !0)),
...
var P6 = function (t) {
    ...
    return function (u, s) {
      try {
        ...
        const p = r.get(s);
        if (!p) {
          const h = Array.isArray(s) ? s : k0(s);
          if (
            s.constructor &&
            s.constructor.name &&
            s.constructor.name !== "Object" &&
  ...
  V6 = (e, t = {}) => {
    const r = { ...N6, ...t };
    return JSON.stringify(k0(e), P6(r), t.space);
  };
/*!
...
var Y6 = _.div(te, ({ theme: e }) => ({
  ...
  Na = (e) =>
    a.createElement(Y6, { ...e, className: "docblock-emptyblock sb-unstyled" }),
  K6 = _(Ro)(({ theme: e }) => ({
    fontSize: `${e.typography.size.s2 - 1}px`,
    lineHeight: "19px",
    margin: "25px 0 40px",
  ...
  Go = ({
    ...
    if (e) return a.createElement(X6, null);
    ...
    return a.createElement(vs, { theme: ka(s) }, u);
  };
...
var oe = (e) =>
  ...
  nE = ({ children: e }) =>
    a.createElement(
      ...
      a.createElement(tE, { className: "sbdocs sbdocs-content" }, e)
    ),
  In = (e) => ({
    borderRadius: e.appBorderRadius,
    background: e.background.content,
  ...
  iE = ({
    ...
    a.createElement(
      ...
      a.createElement(
        ...
        { key: "left" },
        e
          ? [1, 2, 3].map((l) => a.createElement(Iu, { key: l }))
          : a.createElement(aE, { zoom: n, resetZoom: o })
      )
    ),
  _0 = A.createContext({ scale: 1 }),
  { window: lE } = fe,
  sE = class extends A.Component {
    ...
    componentDidMount() {
      let { id: e } = this.props;
      this.iframe = lE.document.getElementById(e);
    }
    shouldComponentUpdate(e) {
      let { scale: t } = e;
      return (
  ...
  dE = (e) => {
    ...
    let h = "<span></span>";
    return o
      ? a.createElement("pre", null, a.createElement(Fu, { error: o }))
      : a.createElement(
          a.Fragment,
          null,
          u
  ...
  pE = ({ story: e, height: t = "500px" }) =>
    a.createElement(
      "div",
      { style: { width: "100%", height: t } },
      a.createElement(_0.Consumer, null, ({ scale: r }) =>
        a.createElement(sE, {
          key: "iframe",
          id: `iframe--${e.id}`,
          title: e.name,
          src: Pu(cE, e.id, { viewMode: "story" }),
          allowFullScreen: !0,
          scale: r,
  ...
  fE = (e) => {
    ...
    return a.createElement(
      ...
      t ? a.createElement(dE, { ...e }) : a.createElement(pE, { ...e })
    );
  },
  Ko = () => a.createElement(Zu, null),
  mE = _.div(
...
var yE = _(iE)({ position: "absolute", top: 0, left: 0, right: 0, height: 40 }),
  vE = _.div({ overflow: "hidden", position: "relative" }),
  za = ({
    isLoading: e,
    isColumn: t,
    columns: r,
    ...
    let [h, g] = A.useState(l),
      { source: d, actionItem: m } = hE(o, h, g),
      [f, y] = A.useState(1),
  ...
  EE = _(za)(() => ({ ".docs-story": { paddingTop: 32, paddingBottom: 40 } })),
  xE = () =>
    a.createElement(
      EE,
  ...
  SE = _.span(ct, ({ theme: e, simple: t = !1 }) => ({
    flex: "0 0 auto",
    fontFamily: e.typography.fonts.mono,
    fontSize: e.typography.size.s1,
  ...
  FE = _(Ae)({ height: 10, width: 10, minWidth: 10, marginLeft: 4 }),
  OE = () => a.createElement("span", null, "-"),
  F0 = ({ text: e, simple: t }) => a.createElement(SE, { simple: t }, e),
  RE = Mt(1e3)((e) => {
    let t = e.split(/\r?\n/);
  ...
  Dl = (e, t = !0) => {
    ...
    return (
      t || (r = e.slice(0, qa)),
      r.map((n) => a.createElement(F0, { key: n, text: n === "" ? '""' : n }))
    );
  },
  DE = ({ value: e, initialExpandedArgs: t }) => {
    ...
    if (n == null) {
      if (/[(){}[\]<>]/.test(s)) return a.createElement(F0, { text: s });
      let c = TE(s),
        p = c.length;
      return p > qa
        ? a.createElement(
    ...
    return a.createElement(
      ...
      a.createElement(
        ...
        a.createElement(FE, { icon: o ? "arrowup" : "arrowdown" })
      )
    );
  },
  pa = ({ value: e, initialExpandedArgs: t }) =>
    e == null
      ...
      : a.createElement(DE, { value: e, initialExpandedArgs: t }),
  ME = _.label(({ theme: e }) => ({
    lineHeight: "18px",
    alignItems: "center",
    marginBottom: 8,
  ...
  LE = (e) => e === "true",
  BE = ({ name: e, value: t, onChange: r, onBlur: n, onFocus: o }) => {
  ...
  PE = ({ name: e, value: t, onChange: r, onFocus: n, onBlur: o }) => {
    let [i, l] = A.useState(!0),
      u = A.useRef(),
      s = A.useRef();
    A.useEffect(() => {
      i !== !1 &&
        (u && u.current && (u.current.value = jE(t)),
        s && s.current && (s.current.value = HE(t)));
    }, [t]);
    let c = (g) => {
        let d = $E(g.target.value),
          m = new Date(t);
  ...
  Bl = "Choose option...",
  XE = ({ name: e, value: t, options: r, onChange: n }) => {
    let o = (u) => {
  ...
  f8 = "Symbol",
  M0 = "ADD_DELTA_TYPE",
  L0 = "REMOVE_DELTA_TYPE",
  B0 = "UPDATE_DELTA_TYPE";
function bt(e) {
  return e !== null &&
    typeof e == "object" &&
    !Array.isArray(e) &&
...
var I0 = class extends A.Component {
  ...
  handleRemoveItem(e) {
    return () => {
      ...
      t(e, o, i, l)
        .then(() => {
          let u = { keyPath: o, deep: i, key: e, oldValue: l, type: L0 };
  ...
  handleAddValueAdd({ newValue: e }) {
    ...
    o(t.length, r, n, e)
      .then(() => {
        ...
        u(r[r.length - 1], l),
          s({ type: M0, keyPath: r, deep: n, key: l.length - 1, newValue: e });
      })
      .catch(i.error);
  }
  ...
  handleAddValueAdd({ key: e, newValue: t }) {
    ...
    i(e, n, o, t)
      .then(() => {
        ...
        let { onUpdate: u, onDeltaUpdate: s } = this.props;
        u(n[n.length - 1], r),
          s({ type: M0, keyPath: n, deep: o, key: e, newValue: t });
      })
      .catch(l.error);
  }
  handleRemoveValue(e) {
...
H0.defaultProps = {
  ...
  logger: { error: () => {} },
  onSubmitValueParser: (e, t, r, n, o) => b8(o),
...
var { window: y8 } = fe,
  ...
  w8 = (e) => {
    e.currentTarget.dispatchEvent(new y8.KeyboardEvent("keydown", A8));
  },
  S8 = (e) => {
      ...
      l
        ...
        : a.createElement(H0, {
            ...
            inputElement: (y, b, S, v) =>
              v
                ? a.createElement(jl, { onFocus: S8, onBlur: w8 })
                : a.createElement(jl, null),
            fallback: f,
          })
    );
  },
  k8 = _.input(({ theme: e, min: t, max: r, value: n }) => ({
  ...
  _8 = _(Z0)(({ numberOFDecimalsPlaces: e, max: t }) => ({
    width: `${e + t.toString().length * 2 + 3}ch`,
    textAlign: "right",
    flexShrink: 0,
  })),
  F8 = _.div({ display: "flex", alignItems: "center", width: "100%" });
function O8(e) {
...
var $8 = ({ onChange: e, name: t, accept: r = "image/*", value: n }) => {
  ...
  I8 = A.lazy(() =>
    st(
      () => import("./Color-3YIJY6X7-787c4b3e.js"),
      [
        "./Color-3YIJY6X7-787c4b3e.js",
        "./index-0e95cdc0.js",
        "./_commonjsHelpers-725317a4.js",
        "./index-a517a563.js",
        "./iframe-edd50d93.js",
  ...
  z8 = _.div(({ theme: e, hasDescription: t }) => ({
    color:
      e.base === "light"
        ? ee(0.1, e.color.defaultText)
  ...
  qr = (e) => {
    ...
    return a.createElement(
      ...
      a.createElement(
        U8,
        { expandable: o },
        a.createElement(P8, null, l),
        h ? a.createElement(N8, { title: "Required" }, "*") : null
      ),
      n
        ? null
        : a.createElement(
            "td",
            null,
            g && a.createElement(V8, null, a.createElement(f0, null, u)),
            s.jsDocTags != null
              ? a.createElement(
                  a.Fragment,
                  null,
                  ...
                  a.createElement(wE, { tags: s.jsDocTags })
                )
              : a.createElement(
                  z8,
                  { hasDescription: g },
    ...
    return a.createElement(
      ...
      a.createElement(
        ...
        a.createElement(
          ...
          a.createElement(G8, null, a.createElement(W8, { icon: p }), t)
        ),
        a.createElement(
          J8,
          { colSpan: o - 1 },
  ...
  tx = _.span({ display: "flex", justifyContent: "space-between" }),
  rx = {
  ...
  nx = { rows: { row1: ga("row1"), row2: ga("row2"), row3: ga("row3") } },
  ax = (e, t) => {
  ...
  ix = (e) => {
    ...
    let {
      ...
      u = "isLoading" in e,
      { rows: s, args: c, globals: p } = "rows" in e ? e : nx,
      h = ax(
        nb(s, (f) => {
          var y;
          return (
...
var lx = (e) => `anchor--${e}`,
  P0 = ({ storyId: e, children: t }) =>
    a.createElement("div", { id: lx(e), className: "sb-anchor" }, t);
fe &&
...
var V0 = A.createContext({ sources: {} }),
  z0 = "--unknown--",
  cx = ({ children: e, channel: t }) => {
    let [r, n] = A.useState({});
    return (
      A.useEffect(() => {
        let o = (i, l = null, u = !1) => {
      ...
      a.createElement(V0.Provider, { value: { sources: r } }, e)
    );
  },
  dx = ((e) => (
  ...
  fx = (e, t, r) => {
    let { sources: n } = r,
      o = n == null ? void 0 : n[e];
    return (
      (o == null ? void 0 : o[N0(t)]) ||
      (o == null ? void 0 : o[z0]) || { code: "" }
    );
  },
  mx = ({
    snippet: e,
...
`));
  ...
  hx = (e = { __forceInitialArgs: !1, __primary: !1 }) => {
    ...
    let o = gx(e, n, t);
    return o ? a.createElement(fE, { ...o }) : null;
  },
  bx = (
  ...
  yx = (e) => {
    ...
    let { isLoading: l, previewProps: u } = bx(e, t, r),
      s,
      c,
      p;
    try {
    ...
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#canvas-block
  `),
        l ? a.createElement(xE, null) : a.createElement(za, { ...u }, n)
      );
    let h =
        e.layout ??
        s.parameters.layout ??
  ...
  xx = (e, t) => {
    ...
    let l = A.useCallback(
        (s) => t.channel.emit(U6, { storyId: n, updatedArgs: s }),
        [n, t.channel]
      ),
      u = A.useCallback(
        (s) => t.channel.emit(W6, { storyId: n, argNames: s }),
        [n, t.channel]
      );
    return e && [o, l, u];
  },
...
var Ga = Nu.a,
  ...
  Cx = (e) => {
    let { href: t, target: r, children: n, ...o } = e,
      i = A.useContext(Se);
    if (t) {
      if (t.startsWith("#")) return a.createElement(Sx, { hash: t }, n);
  ...
  ti = (e) => {
    ...
    if (r) return a.createElement(Fx, { as: t, id: r, ...o }, n);
    let i = t,
      { as: l, ...u } = e;
  ...
  Dx = (e) => e && (typeof e == "string" ? e : ha(e.markdown) || ha(e.text)),
  Mx = (e) => e && (typeof e == "string" ? e : ha(e.text)),
  Lx = (e) => null,
  Bx = (e) => {
    var t, r, n, o, i, l, u, s;
    switch (e.type) {
  ...
  $x = ({ type: e, markdown: t, children: r }, { storyById: n }) => {
    ...
    let { extractComponentDescription: c = Lx, description: p } = s || {},
  ...
  Ya = (e) => {
    ...
    return (
      ...
      u ? a.createElement(Rx, null, u) : null
    );
  },
  { document: Ix, window: jx } = fe,
  Hx = ({ context: e, theme: t, children: r }) => (
    A.useEffect(() => {
      let n;
      try {
        if (((n = new URL(jx.parent.location.toString())), n.hash)) {
          let o = Ix.getElementById(n.hash.substring(1));
          o &&
            setTimeout(() => {
              sx(o);
            }, 200);
    ...
    a.createElement(
      ...
      a.createElement(
        cx,
        { channel: e.channel },
        a.createElement(vs, { theme: Xd(t) }, a.createElement(nE, null, r))
      )
    )
  ),
  Zx = /\s*\/\s*/,
  ...
  Nx = ({ children: e }) => {
    let t = A.useContext(Se),
      r = e || Px(t.storyById().title);
    return r
      ? a.createElement(Q6, { className: "sbdocs-title sb-unstyled" }, r)
      : null;
  },
  Vx = ({ children: e }) => {
    let t = A.useContext(Se),
    ...
    return a.createElement(
      ...
      t &&
        a.createElement(
          a.Fragment,
          null,
          a.createElement(zx, null, i.name),
  ...
  Ux = ({ children: e, disableAnchor: t, ...r }) => {
...
var Gx = () => {
    ...
    return a.createElement(
      ...
      a.createElement(qx, null),
      a.createElement(Ax, null),
      r ? null : a.createElement(K0, null)
    );
  },
  o9 = ({ docsParameter: e, context: t }) => {
    let r = e.container || Hx,
      n = e.page || Gx;
    return a.createElement(
      r,
  ...
  i9 = ({ of: e }) => {
    ...
    try {
      let r = t.storyById();
      return a.createElement(P0, { storyId: r.id });
    } catch {
      return null;
    }
  };
...
//# sourceMappingURL=index-533305e4.js.map
