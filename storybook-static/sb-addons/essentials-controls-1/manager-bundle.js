try {
      ...
      if ((t && typeof t == "object") || typeof t == "function")
        for (let a of xy(t))
          !Sy.call(e, a) &&
            ...
            ha(e, a, {
              get: () => t[a],
              enumerable: !(n = Cy(t, a)) || n.enumerable,
            });
      return e;
    };
  var fe = (e, t, r) => (
  ...
  var Pc = F((tU, Rc) => {
    ...
    function Av(e, t, r, n, a, o) {
      ...
      if (g && !y)
        return (
          o || (o = new Do()),
          u || mv(e) ? fv(e, t, r, n, a, o) : hv(e, t, s, r, n, a, o)
        );
      if (!(r & yv)) {
  ...
  var bn = F((lH, Op) => {
    ...
    function ix(e, t, r) {
      var n = e[t];
      (!(ux.call(e, t) && ax(n, r)) || (r === void 0 && !(t in e))) &&
        nx(e, t, r);
    }
    Op.exports = ix;
  });
  ...
  var zf = F((wV, Uf) => {
    ...
    function Fn(e, t, r, n, a, o) {
      ...
      if (y) {
        ...
        if (A == $f || A == qf || (g && !a)) {
          if (((u = s || g ? {} : d5(e)), !i))
            return s ? u5(e, r5(u, e)) : o5(e, t5(u, e));
        } else {
          if (!le[A]) return a ? e : {};
          u = p5(e, A, i);
        }
  ...
  var Un = F((EX, ch) => {
    ...
    var tu = function () {
      ...
      Wt = {},
      YB = typeof Uint8Array > "u" ? ee : Ge(Uint8Array),
      vt = {
        ...
        "%MapIteratorPrototype%":
          typeof Map > "u" || !Gt ? ee : Ge(new Map()[Symbol.iterator]()),
        "%Math%": Math,
        "%Number%": Number,
        "%Object%": Object,
        ...
        "%SetIteratorPrototype%":
          typeof Set > "u" || !Gt ? ee : Ge(new Set()[Symbol.iterator]()),
        "%SharedArrayBuffer%":
    ...
    var uh,
      ...
      Ir = qn(),
      Ln = oh(),
      JB = Ir.call(Function.call, Array.prototype.concat),
      QB = Ir.call(Function.apply, Array.prototype.splice),
      sh = Ir.call(Function.call, String.prototype.replace),
      $n = Ir.call(Function.call, String.prototype.slice),
      ZB = Ir.call(Function.call, RegExp.prototype.exec),
      eT =
        /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
      tT = /\\(\\)?/g,
      rT = function (t) {
        ...
        var a = [];
        return (
          sh(t, eT, function (o, u, i, s) {
            a[a.length] = i ? sh(s, tT, "$1") : u || o;
          }),
          a
        );
      },
  ...
  var $h = F((jX, Lh) => {
    ...
    var du = typeof Map == "function" && Map.prototype,
      ...
      Nr = uT ? WeakMap.prototype.has : null,
      iT = typeof WeakSet == "function" && WeakSet.prototype,
      jr = iT ? WeakSet.prototype.has : null,
    ...
    Lh.exports = function e(t, r, n, a) {
      ...
      if (TT(t)) {
        for (
          ...
          x += " " + S[P].name + "=" + Nh(gT(S[P].value), "double", o);
        return (
          (x += ">"),
      ...
      if (yT(t)) {
        ...
        return !("cause" in Error.prototype) &&
          ...
          ? "{ [" +
              String(t) +
              "] " +
              We.call(Sh.call("[cause]: " + g(t.cause), $), ", ") +
              " }"
          : $.length === 0
          ? "[" + String(t) + "]"
          : "{ [" + String(t) + "] " + We.call($, ", ") + " }";
      ...
      if (FT(t)) return uu("WeakMap");
      if (BT(t)) return uu("WeakSet");
      if (ST(t)) return uu("WeakRef");
      if (AT(t)) return kr(g(Number(t)));
      if (DT(t)) return kr(g(iu.call(t)));
      if (ET(t)) return kr(lT.call(t));
      if (bT(t)) return kr(g(String(t)));
      if (!mT(t) && !Rh(t)) {
        var I = Hn(t, g),
          U = Bh
    ...
    function cu(e) {
      return (
        pt(e) === "[object Array]" &&
        (!Fe || !(typeof e == "object" && Fe in e))
      );
    }
    function mT(e) {
      return (
        pt(e) === "[object Date]" && (!Fe || !(typeof e == "object" && Fe in e))
      );
    }
    function Rh(e) {
      return (
    ...
    function qh(e, t) {
      ...
      var a = ct.call(ct.call(e, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, _T);
...
` +
  ...
  var zh = F(($X, Uh) => {
    ...
    var gu = Un(),
      ...
      Vn = gu("%WeakMap%", !0),
      Kn = gu("%Map%", !0),
      kT = Jt("WeakMap.prototype.get", !0),
      NT = Jt("WeakMap.prototype.set", !0),
      jT = Jt("WeakMap.prototype.has", !0),
      MT = Jt("Map.prototype.get", !0),
      qT = Jt("Map.prototype.set", !0),
      LT = Jt("Map.prototype.has", !0),
      mu = function (e, t) {
    ...
    var Yh = zh(),
      ...
      s8 = function (t) {
        ...
        if (typeof t.format < "u") {
          if (!n8.call(Mr.formatters, t.format))
  ...
  var Jn = F((iJ, rg) => {
    ...
    var y8 = Qh(),
      b8 = tg(),
      A8 = Yn();
    rg.exports = { formats: A8, parse: b8, stringify: y8 };
  });
  var Tg = F((dZ, Bg) => {
    l();
    c();
...
\u2028\u2029])`;
  ...
  var nr,
    ...
    tm = Xe(() => {
      ...
      (zO = typeof window < "u" ? yi : me),
        ...
        (Jg = function (e) {
          return m.createElement(GO, Ft({}, e, { colorModel: WO }));
        }),
        (VO = function (e) {
          var t = e.className,
            r = e.hsva,
        ...
        (em = function (e) {
          return m.createElement(Qg, Ft({}, e, { colorModel: YO }));
        });
    });
  var nm = F((ree, rm) => {
    "use strict";
  ...
  var Am = F((_ee, bm) => {
    ...
    function b4(e) {
      ...
      e = d4(e);
      var r = g4.test(e);
      return r || m4.test(e) ? y4(e.slice(2), r ? 2 : 8) : h4.test(e) ? ym : +e;
    }
    bm.exports = b4;
  });
  var vm = F((Iee, Dm) => {
  ...
  var _m = {};
  fi(_m, { ColorControl: () => Tm, default: () => G4 });
  var ke,
    wm,
    B4,
    T4,
    ...
    Om = Xe(() => {
      ...
      (B4 = q.div({ position: "relative", maxWidth: 250 })),
        ...
        (Bm = ((e) => ((e.RGB = "rgb"), (e.HSL = "hsl"), (e.HEX = "hex"), e))(
          Bm || {}
        )),
        (ua = Object.values(Bm)),
        ...
        (z4 = (e, t) => {
          ...
          let s = rt(() => U4(r, a, u).toLowerCase(), [r, a, u]),
            d = ge(
              (A) => {
                let g = or(A),
                  h = g?.value || A || "";
  ...
  function L2(e, t) {
    ...
    var r = nt(t);
    return at(
      xe({}, r, { saturation: Rt(0, 1, r.saturation - parseFloat(e)) })
    );
  }
  var bk = Pe(L2);
  function $2(e, t) {
  ...
  function Y2(e, t) {
    return t === "transparent"
      ? t
      : at(xe({}, nt(t), { lightness: parseFloat(e) }));
  }
  var Dk = Pe(Y2);
  function X2(e, t) {
    return t === "transparent"
      ? t
      : at(xe({}, nt(t), { saturation: parseFloat(e) }));
  }
  var vk = Pe(X2);
  function J2(e, t) {
      ...
      if ((t && typeof t == "object") || typeof t == "function")
        for (let a of Xf(t))
          !C3.call(e, a) &&
            ...
            Yf(e, a, {
              get: () => t[a],
              enumerable: !(n = D3(t, a)) || n.enumerable,
            });
      return e;
    },
    Jf = (e, t, r) => (
...
`,
  ...
  var G0 = (e, t) => (Array.isArray(t) ? t.includes(e) : e.match(t)),
    ...
    Y0 = (e) => {
      ...
      if (!r) return t;
      let u = Pr(t, n, a),
        i = (0, Or.default)(u, (s, d) => s?.type && $B(s, d, o));
      return Et(i, u);
    };
  Y0.secondPass = !0;
  function Jo(e) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var I8 = Object.create,
    ...
    Ie = (e, t) =>
      function () {
        return (
          t || (0, e[sg(e)[0]])((t = { exports: {} }).exports, t), t.exports
        );
      },
    M8 = (e, t, r, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
    ...
    Qn = (e, t, r) => (
      ...
      M8(
        t || !e || !e.__esModule
          ? ig(r, "default", { value: e, enumerable: !0 })
          : r,
        e
      )
    ),
  ...
  var m_ = g_,
    y_ = "[object Symbol]";
  function b_(e) {
    return typeof e == "symbol" || (m_(e) && Ag(e) == y_);
  }
  var Fu = b_;
  function A_(e, t) {
    for (var r = -1, n = e == null ? 0 : e.length, a = Array(n); ++r < n; )
...
` &&
    ...
    gO = (0, xg.default)(1e4)((e) => hO(e).replace(/\n\s*/g, "").trim()),
    mO = function (t, r) {
  ...
  var bO = function (t) {
    ...
    Tu = (e, t = {}) => {
      let r = { ...wg, ...t };
      return JSON.stringify(Sg(e), bO(r), t.space);
    },
    EO = () => {
      let e = new Map();
      return function t(r) {
  ...
  var Mg = "storybook/docs",
    WZ = `${Mg}/panel`;
  var RO = `${Mg}/snippet-rendered`,
    zr = ((e) => (
      (e.AUTO = "auto"), (e.CODE = "code"), (e.DYNAMIC = "dynamic"), e
    ))(zr || {});
  var W4 = q.div(Tt, ({ theme: e }) => ({
      backgroundColor:
  ...
  var c9 = q(Q4)({
    ...
    m9 = q.span(Bt, ({ theme: e, simple: t = !1 }) => ({
      flex: "0 0 auto",
      fontFamily: e.typography.fonts.mono,
      fontSize: e.typography.size.s1,
    ...
    Qm = ({ text: e, simple: t }) => m.createElement(m9, { simple: t }, e),
    v9 = (0, Vm.default)(1e3)((e) => {
      let t = e.split(/\r?\n/);
  ...
  var { window: cR } = oe,
        ...
        u
          ...
          : m.createElement(ly, {
              ...
              inputElement: (x, S, P, N) =>
                N
                  ? m.createElement(Lm, { onFocus: mR, onBlur: gR })
                  : m.createElement(Lm, null),
              fallback: b,
            })
      );
    },
    ...
    AR = q(cy)(({ numberOFDecimalsPlaces: e, max: t }) => ({
  ...
  var BR = ({ onChange: e, name: t, accept: r = "image/*", value: n }) => {
    ...
    TR = mi(() => Promise.resolve().then(() => (Om(), _m))),
    _R = (e) =>
      m.createElement(
        gi,
      ...
      return m.createElement(
        ...
        n
          ...
          : m.createElement(
              "td",
              null,
              g && m.createElement(kR, null, m.createElement(zo, null, i)),
              s.jsDocTags != null
                ? m.createElement(
                    m.Fragment,
                    null,
...
`));
  ...
  var ti = ka.a,
    ...
    wP = (e) => e && (typeof e == "string" ? e : ra(e.markdown) || ra(e.text)),
    BP = (e) => e && (typeof e == "string" ? e : ra(e.text)),
    TP = (e) => null,
    _P = (e) => {
      switch (e.type) {
        case "story":
